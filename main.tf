...
data "paperspace_template" "my-template-1" {
  id = "twnlo3zj" // this is one of the ML in a Box templates from docs.digitalocean.com/reference/paperspace/core/commands/templates/
}
...
resource "paperspace_machine" "my-machine-1" {
  ...
  network_id = "" // network ID of your Private network within the Private workspace
